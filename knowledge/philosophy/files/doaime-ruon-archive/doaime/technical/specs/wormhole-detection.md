...
```
Wormhole_Score = (Semantic_Similarity * 0.6) + (Context_Similarity * 0.3) - (Commonality_Penalty * 0.1)
...
- [Ruon Dialogue Archive](/philosophy/dialogues/ruon-wormhole-session.md)
