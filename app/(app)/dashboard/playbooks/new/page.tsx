...
export default function NewPlaybookPage() {
  ...
  const [steps, setSteps] = useState<Array<{ command_asset_id: string; sort_order: number; timeout_ms: number; on_failure: string; retry_count: number; probability: number }>>([])
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">새 Playbook</h1>
          <p className="text-muted-foreground text-sm mt-1">이름과 스텝을 설정하세요.</p>
        </div>
      </div>
